...
class ResumenSemanalUpdateView(UpdateView):
    model = ResumenSemanal
    form_class = ResumenSemanalForm
...
class ResumenSemanalDeleteView(DeleteView):
    model = ResumenSemanal
